...
\cite{nordhaus2019climate} makes this point more poignantly in his Nobel lecture:
\begin{quote}
...
Note though that $Q_A$ is less than $Q_B$. In equilibrium, city $A$ will recognize that 
...
\textbf{FORTHCOMING: Brief review of the empirical literature on emissions pricing}
\begin{itemize}
	\item \cite{borenstein2022carbon}
	\item \cite{green2021does}
	\item \cite{burtraw2018}
	\item \cite{burtraw2022_rff}
	\item Need to talk briefly about emissions offsets: John Oliver?
\end{itemize}
